...
public class SpecialBimService implements SpecialService {
    ...
    @Autowired
    public SpecialBimService(BimRepository bimRepository, ProjectTypeRepository projectTypeRepository, EirRepository eirRepository, SpecialBimConverter specialBimConverter) {
    ...
    public Map<String, Object> save (BimRequestDto bimRequestDto) {
        ...
        if (bimRequestDto.getProjectTypeId() != null && !projectTypeRepository.existsById(bimRequestDto.getProjectTypeId())){
        ...
        if (bimRequestDto.getEirId() != null && !eirRepository.existsById(bimRequestDto.getEirId())){
            bim.setEirId(null);
